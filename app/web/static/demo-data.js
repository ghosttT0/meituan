...
- 如果骑手坚持确实无法配送，安慰他们后挂断电话。`,
    conversationText: [
      "agent: 你好，请问是张师傅吗？我是站长。",
      "user: 是我。",
      "agent: 你今天飞毛腿合同已经生效了，今天能开始配送吗？",
      "user: 今天可以跑一会儿。",
      "agent: 单日合同要连续完成要求单量，不然合同会受影响。",
      "user: 好，我知道了。",
    ].join("\n"),
  },
  {
...
- 若无问题，祝其课程顺利、招生满满，结束通话`,
    conversationText: [
      "agent: 您好，请问您是培训机构负责人吗？",
      "user: 对，我是。",
      "agent: 我们直播产品升级了，新增标准直播和低延迟直播两个选项。",
      "user: 这两个有什么区别？",
      "agent: 低延迟互动更顺，适合小班课；标准直播更适合大班课。",
      "user: 明白了，我回头看看。",
    ].join("\n"),
  },
];
